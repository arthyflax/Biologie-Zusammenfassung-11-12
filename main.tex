...
\maketitle
    ...
    \begin{itemize}
        \item Primärstruktur: Aminosäure-Sequenz \\\includegraphics[scale=0.25]{Proteine_Primär}
        \item Sekundärstruktur: \textalpha-Helix- und \textbeta-Faltblatt-Struktur \\\includegraphics[scale=0.25]{Proteine_Sekundär}
        \item Tertiärstruktur: räumliche Struktur des Proteins durch Ausbildung von intramolekularen Bindungen und Wechselwirkungen \\\includegraphics[scale=0.25]{Proteine_Tertiär}
    \end{itemize}
    \filbreak
    \subsection{Coenzyme}
